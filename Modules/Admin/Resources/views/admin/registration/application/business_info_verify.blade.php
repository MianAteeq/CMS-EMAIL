            ...
            class="collapse show" aria-expanded="false">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <div class="ac-footer">
                            <a class="btn btn-primary btn-primary_2" style="float: right;"  href="{{route('admin.business.verify',$user['id'])}}">ACCEPT</a>
                            <a class="btn btn-primary btn-primary_2 mr-2" style="float: right;"  href="{{route('admin.business.decline',$user['id'])}}">DECLINE</a>
