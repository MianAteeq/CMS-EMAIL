...
<div class="row">
    <div class="col-md-3">
        ...
        <p style="color: black;padding-left: 25px;">Status :  @if ($user['application_status']=="IN_REVIEW") Info in Review @else {{$user['application_status']}}  @endif</p>
          <p style="color: black;padding-left: 25px;">Verification status :  @if($user['profile']['trading_name_status']==0)  Pending @elseif ($user['profile']['trading_name_status']==1) Accepted  @else Decline @endif</p>

          @if($user['profile']['trading_name_status']==0)
          <div class="footers" style="border-top: 2px solid black;padding: 10px ">
            <button class="btn btn-primary btn-block" onclick="window.location.href=`{{route('admin.trading.verify',$user['id'])}}`">ACCEPT</button>
            <button class="btn btn-primary btn-block" onclick="window.location.href=`{{route('admin.trading.decline',$user['id'])}}`">DECLINE</button>
            ...
            class="collapse show" aria-expanded="false">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        @if($user['profile']['trading_name_status']==0)
                        <div class="ac-footer">
                            <a class="btn btn-primary btn-primary_2" style="float: right;"  href="{{route('admin.trading.info.verify',$user['id'])}}">VERIFY</a>
