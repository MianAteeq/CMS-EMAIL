        ...
        <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
            ...
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"> Edit Product and Offers
                    </li>
...
<div class="row">
    ...
    <div class="col-md-9" id="contens" style="border-radius: 6px;margin-bottom: 10px;padding-bottom: 10px;margin-top: 0px;">
        <div class="row ">
            <a href="{{route('vender.service.provider.trading.unit')}}"><h4 class="h3"  style="border-radius: 7px; border: 2px solid black; padding: 10px; font-weight: 600; font-size: 17px; color: black;margin-left: 15px;"> Overview</h2></a>
        ...
        <div class="card default-collapse collapse-icon accordion-icon-rotate" style="box-shadow: none;margin-top: -6px;">
            ...
            <a id="headingCollapse1" href="{{redirect()->back()->getTargetUrl()}}" class="card-header info mt-2" style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;" data-toggle=""  aria-expanded="false" >
                <div class="card-title lead collapsed">Edit Product and Offers</div>
            </a>
                ...
                <div class="card-content">
                    <form action="{{route('vender.service.provider.trading.unit.hub.setting.product.offer.update')}}" id="contens" method="POST" enctype="multipart/form-data" id="contens"> @csrf
                        <div class="link-body"  style="padding: 10px">
                            ...
                            <div class="form-group row">
                                <label class="col-md-4 label-control" for="eventRegInput5">Product Price * </label>
                                <div class="col-md-8 mx-auto">
                            ...
                            <div class="form-group row" style="margin-bottom: 0.5rem ">
                                ...
                                <div class="col-md-8 mx-auto">
                                    <select class="select2-placeholder-multiple" name="service_id[]" multiple>
                                        ...
                                        <option value="{{$service['id']}}" @foreach ($product['job_types'] as $jobtype) @if($service['id']==$jobtype['job_type_id']) selected @endif @endforeach >{{$service['name']}}</option>
                                        @endforeach
                                      </select>
                            ...
                            <div class="form-group row" style="margin-bottom: 0.5rem ">
                                ...
                                <div class="col-md-8 mx-auto">
                                    <select class="form-control" name="price_type" >
                                        ...
                                        <option value="STARTING_FROM"  @if($product['price_type']=='STARTING_FROM') selected @endif >STARTING FROM</option>
                            ...
                            <div class="form-group row" style="margin-bottom: 0.5rem ">
                                ...
                                <div class="col-md-8 mx-auto">
                                    <select class="form-control" name="job_coverage_id" >
                            ...
                            <div class="form-group row">
                                <label class="col-md-4 label-control" for="eventRegInput5">Product Description </label>
                                <div class="col-md-8 mx-auto">
                            ...
                            <div class="form-group row">
                                <label class="col-md-4 label-control" for="eventRegInput5">Product Term Condition </label>
                                <div class="col-md-8 mx-auto">
                                    <textarea type="text" id="term_condition" class="form-control" value="" onkeyup="lookup(this);" name="term_condition" placeholder="Product Term Condition">{{$product['term_condition']}}</textarea>
...
<script>
    function submitDetailsForm() {
        let array=['product_name','price','job_coverage_id','price_type'];
