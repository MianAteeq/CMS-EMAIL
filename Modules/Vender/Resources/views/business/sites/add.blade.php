...
<div class="row">
    <div class="col-md-3">
        <div style="border-radius: 7px;border: 2px solid black; ">
            <h4 class="h3" style="font-weight: 600; font-size: 17px;padding: 10px; ">
                <img src="/location.png" style="width: 22px;margin-top: -5px;"> New site
            </h4>
    ...
    <div class="col-md-9"
        ...
        <form action="{{ route('vender.site.store') }}" id="contens" method="POST"
            ...
            <div class="link-body" style="padding: 10px">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 mx-auto">
                        <input type="text" id="address_line_1" onkeyup="lookup(this);" class="form-control"
                            name="address_line_1" required value="" placeholder="Address line one * ">
                        <input type="text" id="address_line_2"  class="form-control"
                            name="address_line_2" required value="" style="margin-top: 5px "
                        ...
                        <input type="text" id="city" class="form-control" onkeyup="lookup(this);" name="city" required
                            value="" style="margin-top: 5px " placeholder="City / Town * ">
                        <input type="postcode" id="postcode" class="form-control" onkeyup="lookup(this);" name="postcode"
                            required value="" style="margin-top: 5px " placeholder="Postcode * ">
                ...
                <div class="form-group row Poof_div">
                    ...
                    <div class="col-md-8 mx-auto">
                        ...
                        <button type="button" class="btn btn-primary btn-sm view-btn" style="display: none"> <a href="" id="view_file" target="_blank"
