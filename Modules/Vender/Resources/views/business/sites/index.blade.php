                     ...
                     <table class="table table-striped table-bordered zero-configuration">
                         ...
                         <tbody>
                             ...
                             <tr>
                                ...
                                <td>{{$site['address_line_1']}} {{$site['address_line_2']}}  @if ($site['is_change']==1)<span style="background-color: #ff6600;" class="badge badge-primary">Registered</span> @endif </td>
                                <td>{{$site['city']}} </td>
                                <td>{{$site['postcode']}}</td>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('vender.site.edit',$site['id'])}}"><i class="ft-edit"></i></a>
                                    @endif
                                    <a href="{{route('vender.site.view',$site['id'])}}"><i class="ft-eye"></i></a></td>
