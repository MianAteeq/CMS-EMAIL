...
<div class="row">
    <div class="col-md-3">
        ...
        <img src="/contact_icon.png" style="width: 22px;margin-top: -5px;" > New trading name
        </h4>
    ...
    <div class="col-md-9"  style="border: 2px solid black;border-radius: 6px;margin-bottom: 10px;padding-left: 0;padding-right: 0;">
        <div class="row" style="margin-right: 0;margin-left: 0;">
         ...
         <form action="{{route('vender.trading.name.store')}}" id="contens" method="POST" enctype="multipart/form-data" id="contens"> @csrf
            <div class="link-body"  style="padding: 10px">

                <div class="form-group row">
                    <label class="col-md-4 label-control" for="eventRegInput5">Trading name * (?)</label>
                    <div class="col-md-8 mx-auto">
                        <input type="text" id="name" class="form-control" value="" onkeyup="lookup(this);" name="name" value="{{old('name')}}" placeholder="Trading name ">
