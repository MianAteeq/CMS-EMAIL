...
<div class="row">
    <div class="col-md-3">
        ...
        <img src="/contact_icon.png" style="width: 22px;margin-top: -5px;" > Edit trading name
        </h4>
    ...
    <div class="col-md-9"  style="border: 2px solid black;border-radius: 6px;margin-bottom: 10px;padding-left: 0;padding-right: 0;">
        <div class="row" style="margin-right: 0;margin-left: 0;">
         ...
         <form action="{{route('vender.trading.name.update')}}" id="contens" method="POST" enctype="multipart/form-data" id="contens">
            @csrf
            ...
            <div class="link-body"  style="padding: 10px">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 mx-auto">
                        <input type="text" id="name" class="form-control" value="{{$trading_name['name']}}" onkeyup="lookup(this);" name="name" placeholder="Trading name ">
                        @if($errors->has('name'))
                ...
                <div class="form-group row Poof_div">
                    <label class="col-md-4 label-control" for="eventRegInput5">Trading name proof* (?)</label>
                    <div class="col-md-8 mx-auto">
                        <input type="file" name="proof" accept="image/*,.doc, .docx,.pdf" class="d-none" id="">
                        <input type="button" id="proof_of_main_contact" class="form-control form-btn" value="{{$trading_name['proof_name']??'Document Upload'}}" name="contact" placeholder="Document Upload ">
                        <button type="button" class="btn btn-primary btn-sm view-btn" > <a href="{{URL::to($trading_name['proof'])}}"
                            id="view_file" target="_blank" style="color: white">View</a></button>
                            <br>
                            <br>
                            <p class="text-danger file_proof" style="padding-left: 10px;width:100%;display: none">Trading name proof is Required !</p>
