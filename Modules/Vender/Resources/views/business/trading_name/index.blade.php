    ...
    padding-right: 0;">
        <div class="row" style="margin-right: 0;margin-left: 0;">
            <div class="col-md-12" style="border-bottom: 2px solid black;">
             <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">Trading names</h3>
            </div>
                     ...
                     <table class="table table-striped table-bordered zero-configuration">
                         ...
                         <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$trading_name['name']}}  @if ($trading_name['is_change']==1) <span style="background-color: #ff6600;" class="badge badge-primary">Registered</span> @endif</td>
                                <td><a href="{{URL::to($trading_name['proof'])}}" target="_blank"> {{$trading_name['proof_name']}}</a></td>
                                <td> {{$user['profile']['organization_status']}}</td>
                                <td>{{$trading_name['status']}}</td>
                                <td>
                                    @if ($trading_name['is_change']==0)

                                    <a href="{{route('vender.trading.name.edit',$trading_name['id'])}}"><i class="ft-edit"></i></a>
                                    @endif
                                    <a href="{{route('vender.trading.name.view',$trading_name['id'])}}"><i class="ft-eye"></i></a></td>
         ...
         <div class="footers">
             ...
             <a href="{{route('vender.trading.name.add')}}">  <button type="button" class="btn btn-dark round btn-min-width mr-1 mb-1"
