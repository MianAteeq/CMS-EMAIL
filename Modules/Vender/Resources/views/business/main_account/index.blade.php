    ...
    padding-right: 0;">
        <div class="row" style="margin-right: 0;margin-left: 0;">
                     ...
                     <table class="table table-striped table-bordered zero-configuration">
                         ...
                         <tbody>
                             ...
                             <tr>
                                ...
                                <td>Active</td>
                                <td><a href="{{route('vender.main.contact.edit',$user['id'])}}"><i class="ft-edit"></i></a> <a href="{{route('vender.main.contact.view',$user['id'])}}"><i class="ft-eye"></i></a></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>{{$account['email']}}</td>
                                <td>{{$account['profile']['phone_no']??''}}</td>
                                <td>Active</td>
                                <td><a href="{{route('vender.main.contact.edit',$account['id'])}}"><i class="ft-edit"></i></a> <a href="{{route('vender.main.contact.view',$account['id'])}}"><i class="ft-eye"></i></a></td>
                            </tr>
         ...
         <div class="footers">
             ...
             <a href="{{route('vender.main.contact.add')}}">  <button type="button" class="btn btn-dark round btn-min-width mr-1 mb-1"
