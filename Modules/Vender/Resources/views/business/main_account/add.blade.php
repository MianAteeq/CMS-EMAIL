...
<div class="row">
    <div class="col-md-3">
        ...
        <img src="/contact_icon.png" style="width: 22px;margin-top: -5px;" > {{$user['name']}} {{$user['middle_name']}}  {{$user['last_name']}}
        </h4>
    ...
    <div class="col-md-9"  style="border: 2px solid black;border-radius: 6px;margin-bottom: 10px;padding-left: 0;padding-right: 0;">
        <div class="row" style="margin-right: 0;margin-left: 0;">
         ...
         <form action="{{route('vender.main.contact.store')}}" id="contens" method="POST" enctype="multipart/form-data" id="contens"> @csrf
            <div class="link-body"  style="padding: 10px">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 mx-auto">
                        <input type="email" id="email" class="form-control" value="" onkeyup="lookup(this);" name="email" placeholder="Email" required>
                        <p class="text-danger email" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">Email Not Valid !</p>
                        @if($errors->has('email'))
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 mx-auto">
                        <input type="text" id="job_title" class="form-control" value="" onkeyup="lookup(this);" name="job_title" placeholder="Position or job title in relation to this business">
                    ...
                    <div class="col-md-8 mx-auto">
                        <div class="input-group">
                            <div class="d-inline-block custom-control custom-radio mr-1">
                                <input type="radio" name="person_authorised" class="custom-control-input" checked value="YES"  id="Yes">
                                <label class="custom-control-label" for="Yes">Yes</label>
                            </div>
                            <div class="d-inline-block custom-control custom-radio">
                                <input type="radio" name="person_authorised" class="custom-control-input" value="NO"  id="No">
                ...
                <div class="form-group row Poof_div">
                    ...
                    <div class="col-md-8 mx-auto">
                        ...
                        <input type="button" id="proof_of_main_contact" class="form-control form-btn" value="Document Upload" name="contact" placeholder="Document Upload ">
