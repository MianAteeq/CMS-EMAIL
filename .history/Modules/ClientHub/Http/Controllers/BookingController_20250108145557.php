        ...
        try {
            ...
            $booking = Booking::with([
                ...
                'contact_detail', 'service', 'job_requests', 'job_requests.job_type', 'job_requests.price_type', 'booking_items','booking_items.job_type','booking_items.price_type', 'vender',
                 'vender.profile','job_requests.job_types','job_requests.job_types.job_type','booking_items', 'booking_items.price_type','booking_items.job_types', 'job_requests.job_types',
            ])->find((int)$request['id']);
